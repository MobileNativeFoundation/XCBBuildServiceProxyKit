...
def xcbbuildserviceproxykit_dependencies():
    ...
    maybe(
        http_archive,
        build_file = "@com_github_mobilenativefoundation_xcbbuildserviceproxykit//:external/com_github_apple_swift_log.BUILD",
    ...
    maybe(
        http_archive,
        build_file = "@com_github_mobilenativefoundation_xcbbuildserviceproxykit//:external/com_github_apple_swift_nio.BUILD",
